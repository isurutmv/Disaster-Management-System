...
<body class="bg-dark">
  <div class="container">
    <div class="card card-register mx-auto mt-5">
      <div class="card-header">Update Disaster</div>
      <div class="card-body">
...
<script type="text/javascript">
 ...
 div#gmap {
        ...
        border:double;
          ...
          <button type="submit" class="btn btn-danger" name="delete" value="delete">Delete</button>                 </form>
